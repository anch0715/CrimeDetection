...
model1 = torchvision.models.resnet50().to(device) # true 옵션으로 사전 학습된 모델을 로드
model2  = torchvision.models.resnet50().to(device)

PATH1 = './weight_res50_bin'
PATH2 = './weight_res50_multi'
