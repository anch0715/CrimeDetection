...
data = CrimeDataset(
    annotations_file="./test5_annotation.csv",
...
model = torchvision.models.efficientnet_b0(weights='DEFAULT').to(device) # true 옵션으로 사전 학습된 모델을 로드
...
def train(model, params):
    ...
    for epoch in range(num_epochs):
      ...
      # 학습 결과 출력
        ...
        torch.save(model.state_dict(), './weight_eff_multi')
