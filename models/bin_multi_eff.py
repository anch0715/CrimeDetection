...
model1 = torchvision.models.efficientnet_b0().to(device) # true 옵션으로 사전 학습된 모델을 로드
model2  = torchvision.models.efficientnet_b0().to(device)

PATH1 = './weight_eff_bin'
PATH2 = './weight_eff_multi'
