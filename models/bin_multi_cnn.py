...
class CNN_multi(torch.nn.Module):
...
model1 = CNN_bin().to(device) # true 옵션으로 사전 학습된 모델을 로드
model2  = CNN_multi().to(device)

PATH1 = './weight_cnn_bin'
PATH2 = './weight_cnn_multi'
